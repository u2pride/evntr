...
@synthesize usernameField, emailField, nameField, profileImageView, continueButton, urlForProfilePicture, facebookID, informationFromFB;
...
- (void) viewWillAppear:(BOOL)animated {
    ...
    NSLog(@"ID THAT I GOT: %@", [self.informationFromFB objectForKey:@"ID"]);
